function TechDiversityRace() {
  ...
  // Values in this array are incremented smoothly to create animation effect.
  ...
  // First entry is empty.
    ...
    this.draw = function () {
        ...
        for (var i = 0; i < this.currentState.length; i++) {
         // averages the animation  over the next 15 frames. actually takes much longer than 15 frames to reach target    
        this.incrementArr[i] = (targetState[i] - this.currentState[i]) / 15; 
         // Increment  values in currentState by values in incrementsArr   
        this.currentState[i] = this.currentState[i] + this.incrementArr[i];       
        }
        ...
        var colours = ['lightblue', '#8C5948', 'pink', 'black', 'orange', 'yellow'];
